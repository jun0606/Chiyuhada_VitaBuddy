...
class ClothingColors {
  ...
  /// 프리셋 이름 (현지화됨)
  static List<String> getPresetNames(BuildContext context) {
    final l10n = AppLocalizations.of(context)!;
    return [
      l10n.clothingPresetDefault,
      l10n.clothingPresetPinkBlack,
      l10n.clothingPresetWhiteNavy,
      l10n.clothingPresetMintCharcoal,
      l10n.clothingPresetLavenderPurple,
      l10n.clothingPresetCoralGray,
    ];
  }

  /// copyWith
  ClothingColors copyWith({Color? braColor, Color? tightsColor}) {
  ...
  Map<String, dynamic> toJson() {
    return {'braColor': braColor.value, 'tightsColor': tightsColor.value};
  }
