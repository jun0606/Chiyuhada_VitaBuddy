  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        if (showLabel) ...[
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  status.getLocalizedMessage(context),
                  style: TextStyle(
                    fontSize: 14,
        ...
        Tooltip(
          message:
              '''${AppLocalizations.of(context)!.intakeTooltip(current.toInt())}
━━━━━━━━━━━━
${AppLocalizations.of(context)!.exerciseBurnTooltip(burned.toInt())}
${AppLocalizations.of(context)!.tdeeBurnTooltip(tdeeBurned.toInt())}
${AppLocalizations.of(context)!.totalBurnTooltip(totalBurned.toInt())}
━━━━━━━━━━━━
${AppLocalizations.of(context)!.currentCaloriesTooltip}: ${netCalories.toInt()} kcal
${AppLocalizations.of(context)!.remainingTooltip(remaining.toInt())}''',
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 13,
                            color: displayNetPercentage > 0.5
                                ? Colors.white
                                : Colors.black87,
                        ...
                        const SizedBox(width: 4),
                        Text(
                          AppLocalizations.of(context)!.currentCaloriesLabel,
                          style: TextStyle(
                            fontSize: 10,
                            color: displayNetPercentage > 0.5
                                ? Colors.white70
...
class _AnimatedCalorieGaugeState extends State<AnimatedCalorieGauge>
  ...
  void didUpdateWidget(AnimatedCalorieGauge oldWidget) {
    ...
    if (oldWidget.current != widget.current ||
      ...
      _animation = Tween<double>(begin: _previousValue, end: widget.current)
          .animate(
